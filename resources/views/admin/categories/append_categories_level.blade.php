...
<div class="form-group">
    <label for="parent_id">Seleccione el nivel de categoría</label> {{-- The relationship between a category and its parent category inside the same table i.e. `categories` table --}}
