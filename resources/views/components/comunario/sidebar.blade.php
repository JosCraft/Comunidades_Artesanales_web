...
<div class="sideadmin ">
    <div class="">
        <ul class="">
            ...
            <li>
                <a href="{{route('comunario.promocion')}}" class="nav-link px-0 align-middle">
                    <i class="fs-4 bi-table"></i> <span class="ms-1 d-none d-sm-inline">Promociones</span></a>
            </li>
            <li>
                <a href="#submenu2" data-bs-toggle="collapse" class="nav-link px-0 align-middle">
                    <i class="fs-4 bi-bootstrap"></i> <span class="ms-1 d-none d-sm-inline">Reporte</span>
                </a>
